...
mobile_payments.pos = {
  ...
  _attach_interceptor: function () {
    ...
    document.addEventListener("click", function (e) {
      ...
      // IMPORTANT: show the dialog BEFORE touching any inputs.
      // Calling _apply_single_selection() fires Vue input events which trigger
      // a POS Awesome panel re-render — that re-render destroys any dialog that
      // was just mounted, so the popup disappears immediately.
      // We pass the clicked button to show_dialog so it can apply selection
      // AFTER the dialog is fully open and the user has confirmed.
