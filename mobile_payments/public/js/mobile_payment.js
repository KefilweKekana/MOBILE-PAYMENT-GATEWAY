  ...
  _show_provider_selection: function (frm, methods, opts) {
    ...
    let dialog_css = `
      <style>
        ...
        .mp-dialog .modal-content { border-radius: 20px; overflow: hidden; border: none; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.25); }
        .mp-dialog .modal-header { display: none !important; }
        .mp-dialog .modal-body { padding: 0 !important; }
        .mp-dialog .modal-body > .frappe-control[data-fieldname="payment_header"] { margin: 0; }
        .mp-dialog .modal-body > .frappe-control:not([data-fieldname="payment_header"]):not([data-fieldname="secure_footer"]):not([data-fieldname="security_badge"]):not([data-fieldname="phone_verified"]) {
          padding: 0 24px;
        }
        .mp-dialog .frappe-control[data-fieldname="phone_verified"] { padding: 0 24px; }
        .mp-dialog .frappe-control[data-fieldname="secure_footer"] { padding: 0 24px; }
        .mp-dialog .frappe-control[data-fieldname="security_badge"] { padding: 0 24px 8px; }
        .mp-dialog .form-group { margin-bottom: 20px; }
        .mp-dialog .control-label { font-size: 13px; font-weight: 600; color: #374151; margin-bottom: 6px; }
        .mp-dialog .form-control, .mp-dialog select.form-control {
          border: 2px solid #e5e7eb !important; border-radius: 10px !important;
          padding: 10px 14px !important; font-size: 14px !important;
          background: #fafafa !important; transition: all 0.2s;
        }
        .mp-dialog .form-control:focus, .mp-dialog select.form-control:focus {
        ...
        .mp-dialog .section-head { display: none; }
        .mp-dialog .form-section:not(:first-child) { border-top: none !important; margin-top: 0 !important; padding-top: 0 !important; }
        .mp-dialog .modal-footer { padding: 0 24px 24px !important; border-top: none !important; }
        .mp-dialog .modal-footer .standard-actions { display: flex; flex-direction: column; align-items: center; gap: 0; }
        .mp-dialog .btn-primary-dark, .mp-dialog .btn-primary {
          background: linear-gradient(135deg, #10b981 0%, #059669 100%) !important;
          border: none !important; font-weight: 600 !important; font-size: 16px !important;
          padding: 14px 32px !important; border-radius: 12px !important; width: 100% !important;
          box-shadow: 0 4px 6px -1px rgba(16,185,129,0.2) !important; transition: all 0.2s !important;
        }
        .mp-dialog .btn-primary-dark:hover, .mp-dialog .btn-primary:hover {
          transform: translateY(-1px); box-shadow: 0 10px 15px -3px rgba(16,185,129,0.3) !important;
        }
        .mp-dialog .btn-secondary, .mp-dialog .btn-default { display: none !important; }
        .mp-amount-header {
          background: linear-gradient(135deg, #10b981 0%, #059669 100%);
          color: #fff; text-align: center; padding: 32px 24px 28px; position: relative; overflow: hidden;
        }
        ...
        .mp-amount-header .mp-label { font-size: 11px; text-transform: uppercase; letter-spacing: 1.5px; opacity: 0.85; margin: 0 0 4px; }
        .mp-amount-header .mp-amount { font-size: 36px; font-weight: 700; margin: 0 0 6px; }
        ...
        .mp-verified { display: flex; align-items: center; gap: 6px; font-size: 12px; color: #6b7280; margin-top: -12px; margin-bottom: 12px; }
        .mp-verified i { color: #10b981; }
        .mp-info-card {
          background: #f0fdf4; border: 1px solid #bbf7d0; border-radius: 12px;
          padding: 14px 16px; display: flex; gap: 12px; align-items: flex-start; margin: 8px 0 4px;
        }
        .mp-info-card .mp-icon {
          flex-shrink: 0; width: 32px; height: 32px; background: #dcfce7; border-radius: 50%;
          display: flex; align-items: center; justify-content: center;
        }
        .mp-info-card .mp-icon i { color: #059669; font-size: 14px; }
        .mp-info-card .mp-text strong { font-size: 13px; color: #1f2937; display: block; margin-bottom: 2px; }
        .mp-info-card .mp-text span { font-size: 11px; color: #6b7280; line-height: 1.4; }
        .mp-security-badge {
          display: flex; align-items: center; justify-content: center; gap: 8px;
          color: #9ca3af; font-size: 11px; padding: 12px 0 0;
        }
        .mp-security-badge .mp-dot { width: 3px; height: 3px; background: #d1d5db; border-radius: 50%; }
        .mp-dialog .help-box { font-size: 12px; color: #6b7280; margin-top: 4px; display: flex; align-items: center; gap: 4px; }
      </style>
    `;
    ...
    let d = new frappe.ui.Dialog({
      ...
      fields: [
        ...
        },
        {
          ...
          options: `
            <div class="mp-info-card">
              <div class="mp-icon"><i class="fa fa-shield"></i></div>
              <div class="mp-text">
                <strong>${__("Secure Transaction")}</strong>
                <span>${__("Your payment is encrypted and processed securely. You'll receive an SMS confirmation once completed.")}</span>
              </div>
            </div>
          `,
        },
        {
          fieldtype: "HTML",
          fieldname: "security_badge",
          options: `
            <div class="mp-security-badge">
              <i class="fa fa-lock"></i> ${__("256-bit SSL Encryption")}
