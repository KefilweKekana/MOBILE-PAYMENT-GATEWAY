...
// ──────────────────────────────────────────────
// Payment Entry Integration — "Pay with Mobile" button
// Shows when Mode of Payment is a mobile money type (ZAAD, Edahab, etc.)
// and the Payment Entry is still a draft (before submit).
// ──────────────────────────────────────────────

frappe.ui.form.on("Payment Entry", {
  refresh: function (frm) {
    mobile_payments._maybe_show_pe_mobile_button(frm);
  },
...
var mobile_payments = {
  ...
  _maybe_show_pe_mobile_button: function (frm) {
    ...
    frm.change_custom_button_type(__("Pay with Mobile"), __("Payment"), "primary");
  },
