  ...
  _show_provider_selection: function (frm, methods, opts) {
    ...
    let dialog_css = `
      <style>
        ...
        .mp-dialog select.form-control,
        .mp-dialog .frappe-control select { padding-right: 36px !important; cursor: pointer !important; }
        ...
        },
        {
          ...
          options: `
            <div class="mp-info-card">
              <div class="mp-icon"><i class="fa fa-shield" style="color:#059669 !important;"></i></div>
              <div class="mp-text">
