      ...
      fields: [
        {
          ...
          options: `
            <div style="text-align:center; padding:8px 0 12px;">
              <i class="fa fa-credit-card fa-3x" style="color:#2ecc71;"></i>
              <h4 style="margin:8px 0 4px;">${format_currency(opts.amount, opts.currency)}</h4>
              <p class="text-muted" style="margin:0; font-size:12px;">${opts.currency} · ${__("auto-detected from invoice")}</p>
            </div>
          `,
        },
        {
