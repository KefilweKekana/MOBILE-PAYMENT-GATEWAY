...
var mobile_payments = {
   ...
   * User selects: Provider → Method → Currency → Phone → Confirm
   */
  ...
  show_appointment_payment_dialog: function (frm) {
    frappe.call({
      ...
      callback: function (r) {
        ...
        let currency = frm.doc.currency || frappe.defaults.get_default("currency") || "USD";
    ...
    let d = new frappe.ui.Dialog({
      ...
      fields: [
        ...
        },
        {
          ...
          options: "USD\nSLSH",
          reqd: 1,
          default: opts.currency === "SLSH" ? "SLSH" : "USD",
      ...
      primary_action: function (values) {
        ...
        let currency = values.currency || "USD";
        ...
        if (is_hpp) {
          ...
          if (opts.doctype === "Patient Appointment") {
            mobile_payments._initiate_appointment_payment(frm, provider, method, values.phone_number, currency);
          } else {
            mobile_payments._initiate_purchase_payment(frm, provider, method, values.phone_number, currency);
          }
        }
      },
    });
