  ...
  _show_provider_selection: function (frm, methods, opts) {
    ...
    let dialog_css = `
      <style>
        ...
        .mp-dialog .modal-body > .frappe-control[data-fieldname="payment_header"] { margin: 0 !important; padding: 0 !important; }
        ...
        .mp-dialog .control-label { font-size: 13px !important; font-weight: 600 !important; color: #374151 !important; margin-bottom: 6px !important; }
        .mp-dialog .form-control, .mp-dialog select.form-control, .mp-dialog .control-input input {
          border: 2px solid #e5e7eb !important; border-radius: 10px !important;
          padding: 11px 14px !important; font-size: 15px !important; height: auto !important;
          background: #fafafa !important; transition: border-color 0.2s, box-shadow 0.2s;
          color: #1f2937 !important; -webkit-appearance: none;
        }
        .mp-dialog .form-control:focus, .mp-dialog select.form-control:focus, .mp-dialog .control-input input:focus {
        ...
        .mp-dialog select.form-control { padding-right: 36px !important; cursor: pointer; }
        .mp-dialog .section-head { display: none !important; }
        .mp-dialog .form-section { border: none !important; padding: 0 !important; margin: 0 !important; }
        .mp-dialog .section-body { padding: 0 !important; }
        .mp-dialog .form-column { padding: 0 !important; }
        .mp-dialog .modal-footer { padding: 20px 28px 24px !important; border-top: none !important; }
        .mp-dialog .modal-footer .standard-actions { width: 100%; }
        ...
        .mp-verified i { color: #10b981; font-size: 13px; }

        .mp-info-card {
          background: #f0fdf4; border: 1px solid #bbf7d0; border-radius: 12px;
          padding: 14px 16px; display: flex; gap: 12px; align-items: flex-start; margin: 4px 0;
        }
        ...
        .mp-security-badge {
          ...
          color: #9ca3af; font-size: 11px; padding: 8px 0 0;
        }
