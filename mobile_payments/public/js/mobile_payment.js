    ...
    let d = new frappe.ui.Dialog({
      ...
      fields: [
        ...
        },
        {
          ...
          description: __("Merchant till numbers only work with HPP flow."),
          depends_on: 'eval:doc.flow_type && doc.flow_type.includes("HPP")',
        },
        {
          fieldname: "phone_number",
          fieldtype: "Data",
          label: __("Phone Number or Merchant ID"),
