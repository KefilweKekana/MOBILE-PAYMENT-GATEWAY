      ...
      callback: function (r) {
        ...
        frappe.call({
          ...
          callback: function (phone_r) {
            ...
            // IMPORTANT: doc.name must be empty so the payment API does NOT
            // try to look up a Sales Invoice with the Payment Entry name.
            var fake_frm = {
              doc: {
                name: "",
                customer: party || "",
            ...
            window.mobile_payments._show_provider_selection(fake_frm, methods, {
              ...
              docname: frm.doc.name,      // display label only (shown in header)
