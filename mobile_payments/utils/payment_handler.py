...
def process_successful_payment(transaction_log, invoice_id=None):
    ...
    """
    # HPP return callbacks run as Guest — switch to Administrator so we can
    # read invoices and create Payment Entries.
    original_user = frappe.session.user
    if original_user == "Guest" or not frappe.has_permission("Sales Invoice", "read", throw=False):
