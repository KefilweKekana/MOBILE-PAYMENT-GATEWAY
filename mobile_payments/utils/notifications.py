...
def _send_email_notification(settings, email, context):
    ...
    try:
        ...
        frappe.log_error(
            message=f"HPP email notification failed: {str(e)}",
            title="HPP Email Error",
        )
...
def _send_sms_notification(settings, phone, context):
    ...
    try:
        ...
        frappe.log_error(
            message=f"HPP SMS notification failed: {str(e)}",
            title="HPP SMS Error",
        )
        return {"sent": False, "message": str(e)}
...
def _send_system_notification(settings, invoice, context):
    ...
    try:
        ...
        frappe.log_error(
            message=f"HPP system notification failed: {str(e)}",
            title="HPP System Notif Error",
        )
        return {"sent": False, "message": str(e)}
...
def _send_slack_notification(settings, context):
    ...
    try:
        ...
        frappe.log_error(
            message=f"HPP Slack notification failed: {str(e)}",
            title="HPP Slack Error",
        )
        return {"sent": False, "message": str(e)}
