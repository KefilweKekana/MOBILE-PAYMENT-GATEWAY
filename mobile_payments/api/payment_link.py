...
def pay(token):
    ...
    # still active (StatusCode 7 "User declined").  Always reuse a Pending
    # session when one exists — the provider portal will show an expiry
    # message itself if the session has timed out on their side.
