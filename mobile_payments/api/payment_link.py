...
def pay(token):
    ...
    outstanding = frappe.db.get_value("Sales Invoice", invoice_id, "outstanding_amount")
    ...
    try:
        ...
        frappe.log_error(frappe.get_traceback(), "Payment Link Error")
        frappe.respond_as_web_page(
            _("Payment Error"),
