...
class WaafiPayClient:
    ...
    def purchase_request(self, phone, amount, method="ZAAD", invoice_id=None,
        ...
        # paymentMethod = MERCHANT_ACCOUNT (not MWALLET_ACCOUNT).
        # payerInfo for subscriber: accountNo = full international mobile number,
        # paymentMethod = MWALLET_ACCOUNT — wallet type (ZAAD/SAHAL/EVC) is identified
        # by the phone number itself, not the channel field.
        if is_merchant:
            payer_info = {
                "accountNo": phone,
            ...
            payment_method_val = channel_info["channel"]  # MWALLET_ACCOUNT
        ...
        payload = {
            ...
            "serviceParams": {
                ...
                "storeId": self.store_id if self.store_id else "",
