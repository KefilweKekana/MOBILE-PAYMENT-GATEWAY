...
class WaafiPayClient:
    ...
    def purchase_request(self, phone, amount, method="ZAAD", invoice_id=None,
        ...
        # serviceParams.paymentMethod is always MWALLET_ACCOUNT — the wallet channel.
        # The merchant vs subscriber distinction is in payerInfo.accountType only.
        if is_merchant:
            payer_info = {
                "accountNo": phone,
        ...
        # paymentMethod at service level is always the wallet channel
