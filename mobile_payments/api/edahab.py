...
class EdahabClient:
    ...
    def purchase_request(self, phone, amount, invoice_id=None,
        ...
        if not self.edahab_number:
            frappe.throw(_("EDahab Number is not configured in Mobile Payment Settings"))
        ...
        payload = {
            "apiKey": self.api_key,
            "edahabNumber": self.edahab_number,
            "amount": amount_val,
            "currency": currency,
    ...
    def create_hpp_session(self, amount, invoice_id=None, description="",
        ...
        # HPP payload — edahabNumber is REQUIRED by Edahab even for HPP.
        # The phone identifies which wallet to charge; HPP just means the
        # customer enters their PIN on a web page instead of USSD popup.
